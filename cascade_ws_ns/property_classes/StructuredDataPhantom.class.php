...
class StructuredDataPhantom extends Property
{
    ...
    {
        if( self::DEBUG ) { u\DebugUtility::out( "Node ID: " . $identifier ); }
        $par_id     = $this->node_map[ $identifier ]->getParentId();
        ...
        // remove ;0
        $field_id = StructuredDataNodePhantom::removeLastIndex( $identifier );
        if( self::DEBUG ) { u\DebugUtility::out( "Field ID: " . $field_id ); }
    ...
    public function setText( $node_name, $text )
    {
        ...
        {
            throw new e\NodeException(
				S_SPAN .  "The node $node_name does not exists." . E_SPAN );
        }
    ...
    public function swapData( $node_name1, $node_name2 )
    {
            ...
            StructuredDataNodePhantom::removeLastIndex( $node_name2 ) )
        {
            throw new e\NodeException(
				S_SPAN .  
            	"The nodes $node_name1 and $node_name2 are not siblings." . E_SPAN );
        }
