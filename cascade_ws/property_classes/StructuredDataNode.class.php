...
class StructuredDataNode extends Property
{
    ...
    public function setBlock( Block $block=NULL )
    {
        ...
        {
            throw new EmptyValueException( "The block cannot be empty" );
        }
    ...
    public function setFile( File $file=NULL )
    {
        ...
        {
            throw new EmptyValueException( "The file cannot be empty" );
        }
    ...
    public function setLinkable( Linkable $linkable=NULL )
    {
        ...
        {
            throw new EmptyValueException( "The linkable cannot be empty" );
        }
    ...
    public function setPage( Page $page=NULL )
    {
        ...
        {
            throw new EmptyValueException( "The page cannot be empty" );
        }
    ...
    public function setSymlink( Symlink $symlink=NULL )
    {
        ...
        {
            throw new EmptyValueException( "The symlink cannot be empty" );
        }
